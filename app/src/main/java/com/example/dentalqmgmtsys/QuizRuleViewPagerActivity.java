...
public class QuizRuleViewPagerActivity extends PagerAdapter {

    Context ctx;

    public QuizRuleViewPagerActivity(Context ctx) {
        this.ctx = ctx;
    }
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        {
            case 0:
                logo.setImageResource(R.drawable.question_mark);
            ...
            case 2:
                ...
                break;
            case 3:
                logo.setImageResource(R.drawable.review);
